      ...
      <div className="container">
        <div className="sobre">
          ...
          <div className="sobre__text">
            ...
            <div className="stats">
              <div className="stat">
                <span className="stat__num">340+</span>
                <span className="stat__label">Avistamientos</span>
              </div>
              <div className="stat">
                <span className="stat__num">12</span>
                <span className="stat__label">Zonas activas</span>
              </div>
              <div className="stat">
                <span className="stat__num">3</span>
                <span className="stat__label">Provincias</span>
              </div>
            </div>
          </div>
